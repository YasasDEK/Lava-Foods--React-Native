...
const SignUpCustomerScreen = ({ navigation }) => {
    ...
    const signupHandle = (email, password) => {
        if (email === '' && password === '') {
            ...
            firebase.auth().createUserWithEmailAndPassword(email, password).then((result) => {
                ...
                result.user.updateProfile({displayName: 'customer'});

                firebase.firestore().collection('customerWithEmail').doc(result.user.uid).set({
                    type: 'customer',
    ...
    return (
        <View style={styles.container}>
            ...
            />
                ...
                <Text style={styles.text}>sign up as a customer</Text>
            </View>
            <Animatable.View
